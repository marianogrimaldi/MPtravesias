...
const cargarMarcas = async () => {
  ...
  for (let marcaVehiculos of datos) {
    let marcaNueva = new MarcaVehiculos(marcaVehiculos.id, marcaVehiculos.name, marcaVehiculos.img, marcaVehiculos.url);
  ...
  for (let marca of marcasV) {
    ...
    marcaNueva.innerHTML = `<a href="${marca.url}" target="blank_"><img src="${marca.img} " alt=" " /> </a>`;
